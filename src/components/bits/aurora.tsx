...
void main() {
  ...
  fragColor = vec4(intensity * rampColor * auroraAlpha, auroraAlpha * 0.85);
}
`;

export function Aurora({
  colorStops = ['#c4c4cc', '#6b6b73', '#f4f4f5'],
  amplitude = 1.05,
  blend = 0.55,
  speed = 0.85,
}: {
  ...
  return <div ref={ctnDom} className="absolute inset-0 pointer-events-none opacity-70" />;
}
